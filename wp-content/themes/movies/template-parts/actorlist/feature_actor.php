<?php
if (isset($args['movie_actor'])) {
    $movie_id = $args['movie_actor'];
    ...
    if ($movie) {
        ...
        <div class="featured-content"
            ...
            <button class="featured-button" onclick="location.href='<?php echo site_url(); ?>/movie-detail?movie_id=<?php echo $movie['id']; ?>'">More</button>
